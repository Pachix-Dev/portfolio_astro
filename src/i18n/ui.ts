...
export const messages = {
  es: {
    ...
    aboutParagraph2: 'He trabajado en diversos proyectos que abarcan desde sitios web corporativos hasta aplicaciones web complejas, utilizando tecnologías como JavaScript, TypeScript, React, Node.js y bases de datos SQL.',

...
export const messages = {
  es: {
    ...
    siteDescription: 'Portafolio de Fabian Yapura Claros, desarrollador web con más de 7 años de experiencia en aplicaciones dinámicas, transformación digital y soluciones tecnológicas innovadoras.',
  ...
  en: {
    ...
    hireme: 'Hire me',
    siteTitle: 'Fabian Yapura Claros',
    siteDescription: 'Portfolio of Fabian Yapura Claros, web developer with over 7 years of experience in dynamic applications, digital transformation, and innovative technological solutions.',
